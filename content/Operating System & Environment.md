...
For personal projects and general coding I use **Neovim** (see the preview in the Neovim & Tmux section). I also use [DevSpace](https://www.devspace.sh) to develop directly inside a container running on a Kubernetes cluster by syncing local files to the container.

> My working and coding environment is heavily influenced by [rwxrob](https://www.youtube.com/@rwxrob).