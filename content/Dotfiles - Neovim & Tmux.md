...
- Lean tmux config; a few small scripts, and the remote version has zero plugins.
- **Ghostty** for macOS because of native automatic background detection.
- **p10k** because it's pretty.
- The `/scripts` folder in my dotfiles contains personal scripts that are in `$PATH`; some are called by tmux.
